...
const workerContent = `// Auto-generated Cloudflare Worker for Umbrella SPA
export default {
  async fetch(request, env) {
    ...
    // Handle API routes - proxy to worker API (will be implemented in subsequent issues)
