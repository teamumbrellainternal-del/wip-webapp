...
export default function Step3() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.secondary_genres.length > 0)
        requestBody.secondary_genres = formData.secondary_genres
      ...
      <div className="mx-auto max-w-4xl py-8">
        ...
        <div className="mb-6">
          ...
          <div className="h-2.5 w-full rounded-full bg-gray-200 dark:bg-gray-700">
            <div className="h-2.5 rounded-full bg-purple-600" style={{ width: '60%' }}></div>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select all tags that fit your profile for each category
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-3">
                      ...
                      <button
                        ...
                        className={`rounded-lg border px-4 py-2 text-sm font-medium transition-colors ${
                          isSelected
                            ...
                            : 'border-gray-200 bg-white hover:border-purple-400 dark:border-gray-700 dark:bg-slate-800'
                        }`}
                      >
                        {option.label}
                      </button>
                ...
                {errors.artist_type && (
                  <p className="text-sm text-destructive">{errors.artist_type}</p>
                )}
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Select all genres that describe your music (max 5)
                </p>
                <div className="grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <p className="text-xs text-muted-foreground">
                  {formData.secondary_genres.length}/5 selected
                </p>
                {errors.secondary_genres && (
                  <p className="text-sm text-destructive">{errors.secondary_genres}</p>
                )}
              </div>
              ...
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  placeholder="e.g.,&#10;The Beatles&#10;Miles Davis&#10;Daft Punk"
                  className="min-h-[120px] w-full rounded-lg border border-gray-200 bg-white p-3 focus:border-transparent focus:ring-2 focus:ring-purple-600 dark:border-gray-700 dark:bg-slate-800"
                  rows={5}
                />
                {errors.influences && (
                  <p className="text-sm text-destructive">{errors.influences}</p>
                )}
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Select all equipment you own or use regularly (max 20)
                </p>
                <div className="grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <p className="text-xs text-muted-foreground">
                  {formData.equipment.length}/20 selected
                </p>
              ...
              <div className="space-y-3">
                <Label className="text-lg font-semibold">
                  Preferred DAW (Digital Audio Workstation)
                </Label>
              ...
              <div className="space-y-3">
                <Label className="text-lg font-semibold">
                  Platforms You Use to Reach Your Audience
                </Label>
                <p className="text-sm text-muted-foreground">
                  Select all platforms where you share your music (max 15)
                </p>
                <div className="grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <p className="text-xs text-muted-foreground">
                  {formData.platforms.length}/15 selected
                </p>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Select all subscriptions and services you use (max 15)
                </p>
                <div className="grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <p className="text-xs text-muted-foreground">
                  {formData.subscriptions.length}/15 selected
                </p>
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  {formData.struggles.length}/10 selected
                </p>
