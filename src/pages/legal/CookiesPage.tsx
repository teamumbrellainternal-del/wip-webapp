  ...
  return (
    <AppLayout>
      ...
      <div className="container mx-auto max-w-4xl px-4 py-8">
        <div className="mb-8">
          <h1 className="mb-2 text-4xl font-bold tracking-tight">Cookie Policy</h1>
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="prose dark:prose-invert max-w-none">
              ...
              <p>
                We use cookies and similar technologies to enhance your experience, keep you logged
                in, remember your preferences, and understand how you use our service.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="mb-2 mt-4 text-lg font-semibold">Preference Cookies</h3>
              <p>
                These cookies allow the website to remember your choices (such as theme preference)
              ...
              <p>
                ...
                collecting and reporting information anonymously. This helps us improve the service.
              </p>
            </CardContent>
          </Card>
              ...
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>Stores your theme preference (light/dark mode).</TableCell>
          ...
          <Card>
            ...
            <CardContent className="prose dark:prose-invert max-w-none">
              ...
              <p>
                ...
                note that if you disable essential cookies, some parts of the website may not
                function properly.
              </p>
              <ul>
                <li>
              ...
              <h3 className="mb-2 mt-4 text-lg font-semibold">Cookie Consent Banner</h3>
              <p>
          ...
          <Card>
            ...
            <CardContent className="prose dark:prose-invert max-w-none">
              ...
              <ul>
                <li>
                  <strong>Clerk</strong> - Authentication service that sets cookies for login
                  sessions
                </li>
                <li>
                  <strong>Cloudflare</strong> - Infrastructure provider that sets cookies for
                  security and performance
                </li>
              </ul>
              <p>
                These third parties have their own privacy policies, and we have no control over
                their cookies. We recommend reviewing their policies:
              </p>
              <ul>
                <li>
                  <a
